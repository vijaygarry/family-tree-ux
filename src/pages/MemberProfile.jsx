...
const MemberProfile = () => {
  ...
  const handleSave = async (e) => {
    ...
    try {
      const response = await api.post("/family/updateMemberProfile", {
        ...form,
  ...
  const handleImageSave = async (croppedImageBlob) => {
    ...
    try {
      ...
      const response = await api.post("/family/updateMemberImage", formData, {
    ...
    <form onSubmit={handleSave}>
      ...
      <div className="row">
        <h5 className="mb-3 float-start">
          Edit {memberProfile.firstName} {memberProfile.lastName}'s Profile
        </h5>
      </div>
              ...
              <div className="row">
                <div className="col-sm-4">
                  ...
                  <input
                    ...
                    value={form.memberAddress?.addressLine1 || ""}
                    onChange={handleFormChange}
                ...
                <div className="col-sm-4">
                  ...
                  <input
                    ...
                    value={form.memberAddress?.addressLine2 || ""}
                    onChange={handleFormChange}
                    className="form-control mb-1"
                ...
                <div className="col-sm-4">
                  ...
                  <input
                    ...
                    value={form.memberAddress?.addressLine3 || ""}
                    onChange={handleFormChange}
                    className="form-control mb-1"
                ...
                <div className="col-sm-4">
                  ...
                  <input
                    ...
                    value={form.memberAddress?.district || ""}
                    onChange={handleFormChange}
                    className="form-control mb-1"
                ...
                <div className="col-sm-4">
                  ...
                  <input
                    ...
                    value={form.memberAddress?.postalCode || ""}
                    onChange={handleFormChange}
                    className="form-control mb-1"
  ...
  const memberReadOnlyView = (
    <div className="container p-4 bg-white rounded mt-4">
      ...
      <h5 className="mb-3 float-start">
        ...
        {memberProfile.firstNameInHindi &&
          ` (${memberProfile.firstNameInHindi}) `}{" "}
        {memberProfile.lastName} Profile
      </h5>
          ...
          <div className="col-sm-4">
            ...
            <div className="mb-2">
              ...
              <span className="text-secondary">
                ...
                {memberProfile.weddingDate &&
                  ` since ${formatISODateToddMMMyyyy(memberProfile.weddingDate)}`}
              </span>
            </div>
            <div className="mb-2">
            ...
            <div className="d-flex  mt-5">
              ...
              {memberProfile.addressSameAsFamily ? (
                ...
                <address className="mb-0">
                  ...
                  {memberProfile.memberAddress?.city},{" "}
                  {memberProfile.memberAddress?.state} -{" "}
            ...
            {memberProfile.familyAddress && (
              <div className="d-flex  mt-5">
                ...
                <address className="mb-0">
                  ...
                  {memberProfile.familyAddress?.city},{" "}
                  {memberProfile.familyAddress?.state} -{" "}
          ...
          >
            <div className="text-end w-100">
              <button
                ...
                onClick={() =>
                  (window.location.href = `/family/${memberProfile.familyId}`)
                }
  ...
  return (
    <div className="container p-4 bg-white rounded mt-4">
      ...
      <RelationshipTable
        membersList={memberData?.parents}
        relationshipHeading="Parents"
      />
      <SpouseTable spouse={memberData?.spouse} />
      <RelationshipTable
        membersList={memberData?.children}
        relationshipHeading="Children"
      />
      <RelationshipTable
