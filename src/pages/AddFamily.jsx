    ...
    <form onSubmit={handleSave}>
      ...
      {createdSuccessfully && (
        <div className="alert alert-success py-1 my-2">
          Family <strong>{familyName}</strong> added successfully with family id{" "}
      ...
      <div className="card mb-5 p-4 bg-body-secondary border-0">
        <div className="row">
          <div className="col-sm-4">
            ...
            <input
              ...
              placeholder={createdSuccessfully ? undefined : "Family Name"}
          ...
          <div className="col-sm-4">
            ...
            <input
              ...
              className="form-control d-inline w-auto"
              placeholder={
                createdSuccessfully ? undefined : "Family Name (Hindi)"
              }
              disabled={!!createdSuccessfully}
            />
          </div>
          <div className="col-sm-4">
            ...
            <input
              ...
              onChange={handleFormChange}
              className="form-control d-inline w-auto"
              placeholder={createdSuccessfully ? undefined : "Gotra"}
              disabled={!!createdSuccessfully}
            />
          </div>
          <div className="col-sm-4">
            ...
            <input
              ...
              onChange={handleFormChange}
              className="form-control d-inline w-auto"
              placeholder={createdSuccessfully ? undefined : "Email"}
              disabled={!!createdSuccessfully}
            />
          </div>
          <div className="col-sm-4">
            ...
            <input
              ...
              onChange={handleFormChange}
              className="form-control d-inline w-auto"
              placeholder={createdSuccessfully ? undefined : "Phone"}
              disabled={!!createdSuccessfully}
            />
          </div>
        </div>
          ...
          <div className="row">
            <div className="col-sm-4">
              ...
              <input
                ...
                placeholder={createdSuccessfully ? undefined : "Address Line 1"}
                disabled={!!createdSuccessfully}
              />
            </div>
            <div className="col-sm-4">
              ...
              <input
                ...
                onChange={handleFormChange}
                className="form-control mb-1"
                placeholder={createdSuccessfully ? undefined : "Address Line 2"}
                disabled={!!createdSuccessfully}
              />
            </div>
            <div className="col-sm-4">
              ...
              <input
                ...
                onChange={handleFormChange}
                className="form-control mb-1"
                placeholder={createdSuccessfully ? undefined : "Address Line 3"}
                disabled={!!createdSuccessfully}
              />
            </div>
            <div className="col-sm-4">
              ...
              <input
                ...
                onChange={handleFormChange}
                className="form-control mb-1"
                placeholder={createdSuccessfully ? undefined : "District"}
                disabled={!!createdSuccessfully}
              />
            </div>
            <div className="col-sm-4">
              ...
              <input
                ...
                onChange={handleFormChange}
                className="form-control mb-1"
                placeholder={createdSuccessfully ? undefined : "City"}
                disabled={!!createdSuccessfully}
              />
            </div>
            <div className="col-sm-4">
            ...
            <div className="col-sm-4">
              ...
              <input
                ...
                onChange={handleFormChange}
                className="form-control mb-1"
                placeholder={createdSuccessfully ? undefined : "Postal Code"}
                disabled={!!createdSuccessfully}
              />
            </div>
            <div className="col-sm-4">
        ...
        {createdSuccessfully ? (
          <div className="mt-3 text-end">
            <button
              type="button"
              className="btn btn-primary fw-bold me-4"
